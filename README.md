...
# 🚀 Neo Hosting Platform – Provided By: Nexus Team
...
Nexus Neo is a Terraform-driven infrastructure engine designed to provision hosting environments on AWS with full OS flexibility and automated deployment logic.
...
* DNS isolated from hosting layer
