...
locals {
  # Use customer email for domain contacts if not specified
  ...
  # Admin contact defaults to registrant if not specified
  ...
  # Tech contact defaults to registrant if not specified
